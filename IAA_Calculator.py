...
# NOTE: we CANNOT use gold standard concepts or its info during training...
# NOTE: Eval metric: F1-score metric.
...
# NOTE: Do we need to add in  ‘Other’/‘C0000000’ ?
cuis = []
infile = open('./data/cuilist.txt') # Orig path: open('./cuilist.txt')
for line in infile:
...
f1_flagged_cuis = get_flagged_cuis_from_annotated_file('./data/annots/s2-resolved.xlsx') # ('./data/annotation_files/sample_annot1.xlsx')
f2_flagged_cuis = get_flagged_cuis_from_annotated_file('./data/annots/s13.xlsx') # ('./data/annotation_files/sample_annot_2.xlsx')
