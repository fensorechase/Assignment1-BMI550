...
# NOTE(Chase): 'result.xlsx' is the submission file(generated by me on  'TEXT' within 'Assignment1GoldStandardSet.xlsx'), 
# Symptom CUIs	Negation Flag within 'Assignment1GoldStandardSet.xlsx' is correct labels.
...
infile = './data/Assignment1GoldStandardSet.xlsx'
outfile = './data/result.xlsx' 
